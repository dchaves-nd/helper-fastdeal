...
const OnboardingPage = () => {
  ...
  return (
    <div className="min-h-screen flex bg-gradient-fastdeal-bg font-verdana">
      <aside className="w-64">
        <SidebarNav activeSection={activeSection} />
      </aside>
      <main ref={contentRef} className="flex-1 ml-64 p-8 space-y-10 max-w-4xl mx-auto"> {/* ml-64 para compensar a sidebar fixa */}
